...
(function($) {
    $.widget("ui.tagit", {
        ...
        _create: function() {
            ...
            this.options.open = this.options.autocompleteOpen;
            ...
            this.input.keydown(function(e) { 
                ...
                if(self.options.regex){
                    result = self.options.regex.test(self.input.val());
                }
                ...
                if (self._isInitKey(e.which)) {
                    e.preventDefault();
                    if (!self.options.allowNewTags || (self.options.maxTags !== undefined && self.tagsArray.length == self.options.maxTags) || !result) { 
                      self.input.val("");
                    }
        ...
        _addTag: function(label, value) {
            ...
            if (this.options.allowRemove) {
            	tag.append('<a class="tagit-close">x</a>');
            }
        ...
        add: function(label, value) {
            ...
            tag = $('<li class="tagit-choice"'
            	...
            	+ '><span>' + label + '</span>');
            if (this.options.allowRemove) {
            	tag.append('<a class="tagit-close">x</a></li>');
            }
            tag.insertBefore(this.input.parent());
