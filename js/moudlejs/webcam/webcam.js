	...
	*/
	...
	// Everything is under a 'webcam' Namespace
	 return {
		...
		swf_url: '/public/image/webcam/webcam.swf', // URI to webcam.swf movie (defaults to cwd)
		shutter_url: '/public/image/webcam/shutter.mp3', // URI to shutter.mp3 sound
		...
		set_shutter_sound: function(enabled, url) {
			...
			this.shutter_url = url ? url : this.shutter_url;
		},
